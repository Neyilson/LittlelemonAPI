...
SECRET_KEY = 'django-insecure-te$-b4%iq8=@_#db=htk-gwrn-#wd4z2bv%wdip&d+$dm(=3$_'
...
INSTALLED_APPS = [
    ...
    'LittleLemonAPI',  # Custom app for the Little Lemon project
    'rest_framework',  # Django REST framework for building APIs
    'rest_framework.authtoken',  # Token authentication for REST framework
    'djoser',  # Django REST framework for user authentication
]
